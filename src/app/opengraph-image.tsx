...
export const alt = "Ant Venture — Collective Intelligence for the AI Era";
...
export default function Image() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: 64, color: "#fff", background: "#0b0b0b", fontFamily: "serif" }}>
      ...
      <div style={{ display: "flex", fontSize: 86, lineHeight: 1, letterSpacing: -4 }}>Collective Intelligence,<br />Engineered for Growth</div>
